    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav className="mb-6" aria-label="Breadcrumb">
        <ol className="flex items-center space-x-2 text-sm text-gray-500">
          <li>
            <Link to={path("/")} className="hover:text-[#10B981] transition-colors">
              {t("home")}
            </Link>
          </li>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1.5">
                {features.map((f, i) => (
                  ...
                  >
                    <Star className="w-4 h-4 text-[#10B981] flex-shrink-0 mt-0.5" />
                    {f}
                  </li>
                ))}
              </ul>
          ...
          <div className="pt-4">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 w-full sm:w-auto bg-[#10B981] hover:bg-[#059669] text-white font-semibold py-3 px-8 rounded-lg transition-colors"
            >
              {t("buyNow")}
